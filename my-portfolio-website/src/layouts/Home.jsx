  ...
  return (
    <>
      <div className="avatar" id="portfolio">
        <div className="w-28 border-[5px] border-secondary border-opacity-35 hover:border-primary rounded-full transition-all duration-300">
      ...
      <div className="join gap-x-2">
        <button className="btn hover:shadow-lg btn-primary text-slate-50 px-7 rounded-full text-base">
          Github
          <svg
