...
const Experience = () => {
  return (
    <div id="experience" className="md:mx-16">
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono italic">09/2017</time>
            <div className="text-lg font-medium">Self Learning</div>
            Strive to continue learning new languages and frameworks to provide
            mentorship and guidance to new comers aspiring to become software
            developers or engineer.
          </div>
        </li>
      </ul>
    </div>
